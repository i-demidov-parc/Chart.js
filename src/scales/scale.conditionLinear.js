...
module.exports = function(Chart) {
	...
	var ConditionLinearScale = Chart.LinearScaleBase.extend({

		draw: function (chartArea) {
			Chart.LinearScaleBase.prototype.draw.apply(this, arguments);

			this.drawBoundaries(chartArea);
		},

		drawBoundaries: function (chartArea) {
			var me = this;
			var context = me.ctx;
			var chart = me.chart;
			var config = chart.config;
			var data = config.data;
			var conditionBoundaries = [];
			var boundaryY;

			for (var key in data.conditionBoundaries) {
				if (data.conditionBoundaries.hasOwnProperty(key)) {
					conditionBoundaries.push(data.conditionBoundaries[key]);
				}
			}
	...
	scaleService.registerScaleType('conditionLinear', ConditionLinearScale, defaultConfig);
};
